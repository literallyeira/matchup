    ...
    return (
      <main className="min-h-screen flex flex-col items-center justify-center py-20 px-4">
        <div className="card max-w-md w-full text-center">
          ...
          <h1 className="text-xl font-bold mb-2">Siparişlerim</h1>
          <p className="text-[var(--matchup-text-muted)] mb-6">Sipariş geçmişinizi görmek için giriş yapın.</p>
    ...
    <main className="min-h-screen py-12 px-4">
      <div className="max-w-lg mx-auto">
        ...
        <div className="card">
          ...
          <p className="text-[var(--matchup-text-muted)] text-sm mb-6">Üyelik ve ödeme geçmişiniz.</p>

          {orders.length === 0 ? (
            <div className="text-center py-12 text-[var(--matchup-text-muted)]">
              <i className="fa-solid fa-receipt text-5xl mb-4 opacity-50" />
              <p>Henüz sipariş bulunmuyor.</p>
              <p className="text-sm mt-1">Üyelik veya ödeme yaptığınızda burada listelenecek.</p>
              <Link href="/" className="btn-secondary mt-6 inline-block">Ana Sayfaya Dön</Link>
            </div>
          ) : (
